...
<body>
    ...
    -->        <a href="Admin_signup.php" class="btn btn-outline-light" style="margin-right:40px; border:0px;">ADMIN SIGN UP </a>
            <a href="Student_login.php"class="btn btn-outline-danger" style="border:0px;">STUDENT LOGIN</a>
...
<div  class="row">
        ...
        <div class="col-5">
            <img src="IMG/Admin_login.png" style="margin-left:120px; margin-top:60px;" width="300">
        </div>
